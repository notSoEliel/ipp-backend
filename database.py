        ...
        if not db.query(models.Sermon).first():
            ...
            sermons_data = [
                models.Sermon(
                    ...
                    image_url="https://placehold.co/600x400/1B5E20/FFFFFF?text=Serm%C3%B3n+1",
                ...
                models.Sermon(
                    ...
                    image_url="https://placehold.co/600x400/4CAF50/FFFFFF?text=Serm%C3%B3n+2",
                ...
                models.Sermon(
                    ...
                    image_url="https://placehold.co/600x400/81C784/FFFFFF?text=Serm%C3%B3n+3",
                    video_url="https://www.youtube.com/watch?v=dQw4w9WgXcQ",
                ),
            ]
